...
class DataStore {
    ...
    func fetchData () {
            ...
            do {
                ...
                messages = try self.managedObjectContext.executeFetchRequest(messageFetch) as! [Message]
    ...
    func generateTestData() {
        ...
        message3.content = "Have a wonderful day."
